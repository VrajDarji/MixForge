...
- Planner diagnostics included from day one (see implementation.md Phase 1):
- retrofitting these into a planner that doesn't already thread them
...
// ============================================================================
// Renderer — deterministic execution, no scoring logic (ADR summary table)
// ============================================================================
